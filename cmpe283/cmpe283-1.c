 ...
 * See SDM volume 3, Table 23-6, Section 23.6.2
 */
 ...
 * See SDM volume 3, Table 23-12, Section 23.7.1
 */
 ...
 * See SDM volume 3,Table 23-14, Section 23.8.1
 */
 ...
 * See SDM volume 3, Table 23-7, Section 23.6.2
 */
struct capability_info procbased_secondary[27] =
{
	...
	{ 23, "Sub-page write permissions forEPT" },
...
detect_vmx_features(void)
{
	...
	pr_info("\nSecondary Procbased MSR: 0x%llx\n",
		(uint64_t)(lo | (uint64_t)hi << 32));
